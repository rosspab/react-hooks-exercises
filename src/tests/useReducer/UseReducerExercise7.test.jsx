...
import UseReducerExercise7 from '../../exercises/useReducer/UseReducerExercise7';

describe('UseReducerExercise7: Crea un sistema de favoritos utilizando useReducer', () => {
  it('se renderiza correctamente y permite incrementar y decrementar el contador', () => {
    render(<UseReducerExercise7 />);
