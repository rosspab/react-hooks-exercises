...
import UseReducerExercise1 from '../../exercises/useReducer/UseReducerExercise1';

describe('UseReducerExercise1: Crea un contador básico utilizando useReducer', () => {
  it('se renderiza correctamente y permite incrementar y decrementar el contador', () => {
    render(<UseReducerExercise1 />);
