...
import UseReducerExercise9 from '../../exercises/useReducer/UseReducerExercise9';

describe('UseReducerExercise9: Implementa una lista de productos con useReducer', () => {
  it('se renderiza correctamente y permite incrementar y decrementar el contador', () => {
    render(<UseReducerExercise9 />);
