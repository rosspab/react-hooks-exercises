...
import UseReducerExercise24 from '../../exercises/useReducer/UseReducerExercise24';

describe('UseReducerExercise24: Maneja un contador que guarda un historial de cambios con useReducer', () => {
  it('se renderiza correctamente y permite incrementar y decrementar el contador', () => {
    render(<UseReducerExercise24 />);
