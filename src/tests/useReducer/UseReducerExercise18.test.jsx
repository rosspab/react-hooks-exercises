...
import UseReducerExercise18 from '../../exercises/useReducer/UseReducerExercise18';

describe('UseReducerExercise18: Crea una galería de imágenes con selección múltiple utilizando useReducer', () => {
  it('se renderiza correctamente y permite incrementar y decrementar el contador', () => {
    render(<UseReducerExercise18 />);
