...
import UseReducerExercise8 from '../../exercises/useReducer/UseReducerExercise8';

describe('UseReducerExercise8: Usa useReducer para controlar el estado de un modal', () => {
  it('se renderiza correctamente y permite incrementar y decrementar el contador', () => {
    render(<UseReducerExercise8 />);
