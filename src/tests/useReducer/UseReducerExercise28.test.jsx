...
import UseReducerExercise28 from '../../exercises/useReducer/UseReducerExercise28';

describe('UseReducerExercise28: Implementa un formulario largo con validación de múltiples campos utilizando useReducer', () => {
  it('se renderiza correctamente y permite incrementar y decrementar el contador', () => {
    render(<UseReducerExercise28 />);
