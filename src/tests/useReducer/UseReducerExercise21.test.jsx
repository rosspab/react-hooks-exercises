...
import UseReducerExercise21 from '../../exercises/useReducer/UseReducerExercise21';

describe('UseReducerExercise21: Maneja la selección de una lista de opciones con useReducer', () => {
  it('se renderiza correctamente y permite incrementar y decrementar el contador', () => {
    render(<UseReducerExercise21 />);
