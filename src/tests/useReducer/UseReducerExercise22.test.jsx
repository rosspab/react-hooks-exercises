...
import UseReducerExercise22 from '../../exercises/useReducer/UseReducerExercise22';

describe('UseReducerExercise22: Implementa un sistema de pestañas (tabs) utilizando useReducer', () => {
  it('se renderiza correctamente y permite incrementar y decrementar el contador', () => {
    render(<UseReducerExercise22 />);
