...
import UseReducerExercise2 from '../../exercises/useReducer/UseReducerExercise2';

describe('UseReducerExercise2: Maneja un formulario simple con useReducer', () => {
  it('se renderiza correctamente y permite incrementar y decrementar el contador', () => {
    render(<UseReducerExercise2 />);
