...
import UseReducerExercise5 from '../../exercises/useReducer/UseReducerExercise5';

describe('UseReducerExercise5: Implementa un contador con incremento y decremento utilizando useReducer', () => {
  it('se renderiza correctamente y permite incrementar y decrementar el contador', () => {
    render(<UseReducerExercise5 />);
