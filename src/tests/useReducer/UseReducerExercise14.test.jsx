...
import UseReducerExercise14 from '../../exercises/useReducer/UseReducerExercise14';

describe('UseReducerExercise14: Maneja el estado de un carrito de compras utilizando useReducer', () => {
  it('se renderiza correctamente y permite incrementar y decrementar el contador', () => {
    render(<UseReducerExercise14 />);
