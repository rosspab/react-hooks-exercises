...
import UseReducerExercise30 from '../../exercises/useReducer/UseReducerExercise30';

describe('UseReducerExercise30: Maneja el estado de un sistema de comentarios utilizando useReducer', () => {
  it('se renderiza correctamente y permite incrementar y decrementar el contador', () => {
    render(<UseReducerExercise30 />);
