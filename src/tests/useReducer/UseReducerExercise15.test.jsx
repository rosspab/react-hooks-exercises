...
import UseReducerExercise15 from '../../exercises/useReducer/UseReducerExercise15';

describe('UseReducerExercise15: Implementa un sistema de votación utilizando useReducer', () => {
  it('se renderiza correctamente y permite incrementar y decrementar el contador', () => {
    render(<UseReducerExercise15 />);
