...
import UseReducerExercise3 from '../../exercises/useReducer/UseReducerExercise3';

describe('UseReducerExercise3: Implementa un estado de múltiples campos utilizando useReducer', () => {
  it('se renderiza correctamente y permite incrementar y decrementar el contador', () => {
    render(<UseReducerExercise3 />);
