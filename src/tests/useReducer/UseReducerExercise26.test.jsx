...
import UseReducerExercise26 from '../../exercises/useReducer/UseReducerExercise26';

describe('UseReducerExercise26: Crea un editor de texto con múltiples estados utilizando useReducer', () => {
  it('se renderiza correctamente y permite incrementar y decrementar el contador', () => {
    render(<UseReducerExercise26 />);
