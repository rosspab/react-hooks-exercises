...
import UseReducerExercise13 from '../../exercises/useReducer/UseReducerExercise13';

describe('UseReducerExercise13: Crea un temporizador utilizando useReducer', () => {
  it('se renderiza correctamente y permite incrementar y decrementar el contador', () => {
    render(<UseReducerExercise13 />);
