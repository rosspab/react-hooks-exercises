...
import UseReducerExercise17 from '../../exercises/useReducer/UseReducerExercise17';

describe('UseReducerExercise17: Maneja la visibilidad de elementos en pantalla con useReducer', () => {
  it('se renderiza correctamente y permite incrementar y decrementar el contador', () => {
    render(<UseReducerExercise17 />);
