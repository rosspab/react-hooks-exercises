...
import UseReducerExercise12 from '../../exercises/useReducer/UseReducerExercise12';

describe('UseReducerExercise12: Implementa una calculadora básica utilizando useReducer', () => {
  it('se renderiza correctamente y permite incrementar y decrementar el contador', () => {
    render(<UseReducerExercise12 />);
