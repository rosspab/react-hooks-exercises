...
import UseMemoExercise17 from '../../exercises/useMemo/UseMemoExercise17';

describe('UseMemoExercise17: Calcula el área de un círculo memoizado con useMemo', () => {
  it('se renderiza correctamente y memoriza el valor', () => {
    render(<UseMemoExercise17 />);
