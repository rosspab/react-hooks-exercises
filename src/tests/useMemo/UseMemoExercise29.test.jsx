...
import UseMemoExercise29 from '../../exercises/useMemo/UseMemoExercise29';

describe('UseMemoExercise29: Memoriza el historial de un contador con useMemo', () => {
  it('se renderiza correctamente y memoriza el valor', () => {
    render(<UseMemoExercise29 />);
