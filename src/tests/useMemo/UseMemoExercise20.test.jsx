...
import UseMemoExercise20 from '../../exercises/useMemo/UseMemoExercise20';

describe('UseMemoExercise20: Memoriza una lista de números primos generada con useMemo', () => {
  it('se renderiza correctamente y memoriza el valor', () => {
    render(<UseMemoExercise20 />);
