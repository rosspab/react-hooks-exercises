...
import UseMemoExercise25 from '../../exercises/useMemo/UseMemoExercise25';

describe('UseMemoExercise25: Calcula el cuadrado de un número con useMemo', () => {
  it('se renderiza correctamente y memoriza el valor', () => {
    render(<UseMemoExercise25 />);
