...
import UseMemoExercise5 from '../../exercises/useMemo/UseMemoExercise5';

describe('UseMemoExercise5: Memoriza el valor máximo en una lista de números con useMemo', () => {
  it('se renderiza correctamente y memoriza el valor', () => {
    render(<UseMemoExercise5 />);
