...
import UseMemoExercise26 from '../../exercises/useMemo/UseMemoExercise26';

describe('UseMemoExercise26: Memoriza los valores únicos de una lista de productos con useMemo', () => {
  it('se renderiza correctamente y memoriza el valor', () => {
    render(<UseMemoExercise26 />);
