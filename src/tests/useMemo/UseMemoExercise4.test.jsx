...
import UseMemoExercise4 from '../../exercises/useMemo/UseMemoExercise4';

describe('UseMemoExercise4: Memoriza una lista de tareas completadas con useMemo', () => {
  it('se renderiza correctamente y memoriza el valor', () => {
    render(<UseMemoExercise4 />);
