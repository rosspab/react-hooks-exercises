...
import UseMemoExercise6 from '../../exercises/useMemo/UseMemoExercise6';

describe('UseMemoExercise6: Memoriza un cálculo pesado de suma con useMemo', () => {
  it('se renderiza correctamente y memoriza el valor', () => {
    render(<UseMemoExercise6 />);
