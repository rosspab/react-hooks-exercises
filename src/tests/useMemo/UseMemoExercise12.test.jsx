...
import UseMemoExercise12 from '../../exercises/useMemo/UseMemoExercise12';

describe('UseMemoExercise12: Memoriza la clasificación de una lista de elementos con useMemo', () => {
  it('se renderiza correctamente y memoriza el valor', () => {
    render(<UseMemoExercise12 />);
