...
import UseMemoExercise16 from '../../exercises/useMemo/UseMemoExercise16';

describe('UseMemoExercise16: Memoriza una lista de notas ordenada por prioridad usando useMemo', () => {
  it('se renderiza correctamente y memoriza el valor', () => {
    render(<UseMemoExercise16 />);
