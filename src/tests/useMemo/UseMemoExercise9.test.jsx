...
import UseMemoExercise9 from '../../exercises/useMemo/UseMemoExercise9';

describe('UseMemoExercise9: Memoriza el valor de una búsqueda filtrada en una lista de usuarios con useMemo', () => {
  it('se renderiza correctamente y memoriza el valor', () => {
    render(<UseMemoExercise9 />);
