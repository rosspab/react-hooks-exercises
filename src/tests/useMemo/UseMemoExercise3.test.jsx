...
import UseMemoExercise3 from '../../exercises/useMemo/UseMemoExercise3';

describe('UseMemoExercise3: Calcula un factorial memoizado con useMemo', () => {
  it('se renderiza correctamente y memoriza el valor', () => {
    render(<UseMemoExercise3 />);
