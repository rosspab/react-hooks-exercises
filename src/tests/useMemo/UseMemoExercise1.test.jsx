...
import UseMemoExercise1 from '../../exercises/useMemo/UseMemoExercise1';

describe('UseMemoExercise1: Memoriza el valor doble de un número con useMemo', () => {
  it('se renderiza correctamente y memoriza el valor', () => {
    render(<UseMemoExercise1 />);
