...
import UseMemoExercise15 from '../../exercises/useMemo/UseMemoExercise15';

describe('UseMemoExercise15: Memoriza los valores de un contador de doble incremento con useMemo', () => {
  it('se renderiza correctamente y memoriza el valor', () => {
    render(<UseMemoExercise15 />);
