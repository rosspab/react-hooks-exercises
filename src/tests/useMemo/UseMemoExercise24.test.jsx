...
import UseMemoExercise24 from '../../exercises/useMemo/UseMemoExercise24';

describe('UseMemoExercise24: Memoriza la lista de categorías seleccionadas con useMemo', () => {
  it('se renderiza correctamente y memoriza el valor', () => {
    render(<UseMemoExercise24 />);
