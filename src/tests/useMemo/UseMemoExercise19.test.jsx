...
import UseMemoExercise19 from '../../exercises/useMemo/UseMemoExercise19';

describe('UseMemoExercise19: Memoriza el tiempo transcurrido desde una fecha inicial con useMemo', () => {
  it('se renderiza correctamente y memoriza el valor', () => {
    render(<UseMemoExercise19 />);
