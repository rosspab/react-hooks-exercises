...
import UseMemoExercise8 from '../../exercises/useMemo/UseMemoExercise8';

describe('UseMemoExercise8: Calcula el promedio de una lista de números usando useMemo', () => {
  it('se renderiza correctamente y memoriza el valor', () => {
    render(<UseMemoExercise8 />);
