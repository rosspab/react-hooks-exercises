...
import UseMemoExercise7 from '../../exercises/useMemo/UseMemoExercise7';

describe('UseMemoExercise7: Memoriza el valor de un filtro de productos con useMemo', () => {
  it('se renderiza correctamente y memoriza el valor', () => {
    render(<UseMemoExercise7 />);
