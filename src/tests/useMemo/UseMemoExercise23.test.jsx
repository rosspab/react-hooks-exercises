...
import UseMemoExercise23 from '../../exercises/useMemo/UseMemoExercise23';

describe('UseMemoExercise23: Memoriza la secuencia Fibonacci con useMemo', () => {
  it('se renderiza correctamente y memoriza el valor', () => {
    render(<UseMemoExercise23 />);
