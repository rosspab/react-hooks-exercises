...
import UseMemoExercise30 from '../../exercises/useMemo/UseMemoExercise30';

describe('UseMemoExercise30: Memoriza la lista de tareas completadas en una semana con useMemo', () => {
  it('se renderiza correctamente y memoriza el valor', () => {
    render(<UseMemoExercise30 />);
