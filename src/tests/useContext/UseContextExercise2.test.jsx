...
import UseContextExercise2 from '../../exercises/useContext/UseContextExercise2';
import { createContext } from 'react';

// Crea un contexto para usar en el test
const ExampleContext = createContext('Valor de prueba');

describe('UseContextExercise2: Crea un contexto para el tema oscuro y claro', () => {
  it('se renderiza correctamente y muestra el valor del contexto', () => {
    ...
    const header = screen.getByText('Crea un contexto para el tema oscuro y claro');
